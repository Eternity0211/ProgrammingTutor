...
// Test Setup
// =============================================================================
const ERRORS_DIR = path_1.default.resolve(process.cwd(), "data/symbolic/ast-patterns/cpp/errors");
const WARNINGS_DIR = path_1.default.resolve(process.cwd(), "data/symbolic/ast-patterns/cpp/warnings");
// 确保环境基本就绪（仅警告，不阻断，因为 Service 应具备容错性）
beforeAll(() => {
    if (!fs_1.default.existsSync(ERRORS_DIR) || !fs_1.default.existsSync(WARNINGS_DIR)) {
