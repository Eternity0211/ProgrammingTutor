...
import { AlertCircle, Lightbulb, GraduationCap, ChevronRight } from "lucide-react";
...
export default function DiagnosticPanel({ 
  ...
  return (
    <div className={`space-y-6 overflow-y-auto h-full p-4 bg-[#1e1e1e] text-gray-200 custom-scrollbar ${className}`}>
      {/* 1. 符号引擎诊断结果列表 */}
      <section>
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div className="flex flex-col gap-1">
                  {/* RuleID & 教学标签 */}
                  <span className="text-[10px] font-mono text-blue-400 opacity-80">{issue.ruleId}</span>
